      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="h-14 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6 text-sm">
            <Link to="/" className="hover:underline">{t('nav_home')}</Link>
            <Link to="/shows" className="hover:underline">{t('nav_shows')}</Link>
            <Link to="/shows?q=filmler" className="hover:underline">{t('nav_movies')}</Link>
            <Link to="/shows?q=yeni" className="hover:underline">{t('nav_new')}</Link>
            <Link to="/my-list" className="hover:underline">{t('nav_mylist')}</Link>
          </div>
